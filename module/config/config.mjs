...
const npcTables = {
  initiative: npcInitiativeTable,
  hpMp: npcHpMpTable,
  attack: npcAttackTable,
  defense: npcDefenseTable,
  skillDefense: npcSkillDefenseTable,
};
